        ...
        <div className="flex gap-12">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              {/* Visa Card */}
              <div className="bg-white border-2 border-neutral-200 p-6 rounded-lg">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-base font-medium text-neutral-900">Visa Platinum</p>
                      <p className="text-sm text-neutral-600">• • • • • • • • • • • • 4242</p>
                    </div>
                  </div>
                ...
                <p className="text-xs text-neutral-600 mb-4">Expires 12/25</p>
                <div className="flex gap-4">
                  <button className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors">Edit</button>
                  <button className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors">Remove</button>
                </div>
              </div>
              ...
              <div className="bg-white border-2 border-neutral-200 p-6 rounded-lg">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-base font-medium text-neutral-900">Mastercard</p>
                      <p className="text-sm text-neutral-600">• • • • • • • • • • • • 8899</p>
                    </div>
                  </div>
                </div>
                <p className="text-xs text-neutral-600 mb-4">Expires 09/24</p>
                <div className="flex gap-4">
                  <button className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors">Set Default</button>
                  <button className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors">Edit</button>
                  <button className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors">Remove</button>
                </div>
              </div>
              ...
              {/* Add New Card */}
              <div className="bg-neutral-50 border-2 border-dashed border-neutral-300 p-6 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:border-neutral-400 transition-colors">
                <svg className="w-12 h-12 text-neutral-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4v16m8-8H4" />
                </svg>
                <p className="text-sm font-medium uppercase tracking-wider text-neutral-700">Add New Card</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-neutral-600">
                ...
                <li><a href="#" className="hover:text-neutral-900 transition-colors">Terms of Use</a></li>
