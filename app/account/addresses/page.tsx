        ...
        <div className="flex gap-12">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white border-2 border-neutral-200 p-8 rounded-lg">
                ...
                <div className="space-y-2 mb-6">
                  <p className="text-base font-medium text-neutral-900">Eleanor Rigby</p>
                  <p className="text-sm text-neutral-600">1280 Fifth Avenue, Apt 10B</p>
                  <p className="text-sm text-neutral-600">New York, NY 10029</p>
                  <p className="text-sm text-neutral-600">United States</p>
                  <p className="text-sm text-neutral-600">T: +1 646 555 0123</p>
                </div>
              ...
              <div className="bg-white border-2 border-neutral-200 p-8 rounded-lg">
                ...
                <div className="space-y-2 mb-6">
                  <p className="text-base font-medium text-neutral-900">Eleanor Rigby</p>
                  <p className="text-sm text-neutral-600">35 Ocean Drive</p>
                  <p className="text-sm text-neutral-600">East Hampton, NY 11937</p>
                  <p className="text-sm text-neutral-600">United States</p>
                  <p className="text-sm text-neutral-600">T: +1 631 555 0888</p>
                </div>
                <div className="flex gap-4">
                  <button className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors">Edit</button>
                  <button className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors">Remove</button>
                  <button className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors">Set as Default</button>
                </div>
              </div>
            </div>
          </div>
